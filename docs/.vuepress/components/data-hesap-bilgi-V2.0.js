...
{
  ID: 9,
  Name: 'Kart Bilgilerinin Sorgulanması',

},
{
  ID: 10,
  Name: 'Kart Detay Bilgileri',

},
{
  ID: 11,
  Name: 'Kart Hareket Bilgileri',
...
export const ResponseTabsKartlar = [{
  ID: 1,
  Name: '200',
  Color: 'black'
}, {
...
export const ResponseTabsKartDetayBilgileri = [{
  ID: 1,
  Name: '200',
  Color: 'black'
}, {
...
export const ResponseTabsKartHareketBilgileri = [{
  ID: 1,
  Name: '200',
  Color: 'black'
}, {
...
export const hesapBilgisiRizaHeader = [
  ...
  },
  {
      ID: 5,
      Key: 'X-JWS-Signature',
      Value: 'eyJhbGciOiJSUz***************************ia20uY29tLnRyIiwiZXhwIjoxNjk5NDQ2NzY'
  },
  {
      ID: 6,
      Key: 'PSU-Fraud-Check',
      Value: 'eyJ0eXAiOiJKV1Q*************************AiLCJMYXN0UGFzc3dvc'
  }, 
  {
      ID: 7,
      Key: 'PSU-Initiated',
  ...
  },    
  {
      ID: 8,
      Key: 'Authorization',
      Value: 'Bearer eyJhb1234556I1NiIsInR5***************************lQMWlHdXlGeDFackJZeElXZmRz'
  },
];
export const hesapBilgisiRizaResponseHeader = [
  ...
  },
  {
      ID: 6,
      Key: 'X-JWS-Signature',
      Value: 'eyJhbGciOi***********************S5ia20uY29tLnRyIiw'
  },
...
export const odemeEmriErisimBelirteciHeader = [
    {
        ID: 9,
        Key: 'X-Access-Token',
        Value: 'eyJhbGciOiJIUzUx****************************29tLnRyIiwiZXhwIjoxNzAwO'
    },
    {
        ID: 3,
        Key: 'X-TPP-Code',
    ...
    },
    {
        ID: 8,
        Key: 'PSU-Fraud-Check',
        Value: 'eyJ0eXAiOiJKV1Qi****************************9tYWx5RmxhZyI6IjAiLCJMYXN0UGFz'
    },
    {
        ID: 4,
        Key: 'X-JWS-Signature',
        Value: 'eyJhbGciOiJSU**************************S5ia20uY29tLnRyIiwiZXhwIjoxNjk5NDQ'
    },
    {
        ID: 6,
        Key: 'PSU-Initiated',
...
export const ErisimBelirteciResponse200 =	{
  "erisimBelirteci": "eyJhbGciOiJIUz****************************wczovL2FwaS5ia20uY29tLnRyIiwiZXhw",
  "gecerlilikSuresi": 300,
  "yenilemeBelirteci": "eyJhbGciO**********************a20uY29tLnRyI",
...
export const YenilemeBelirteciResponse401 =
{
    ...
    "isller": [
      {
        "islTml": {
          ...
          "islTur": "PARA_YATIRMA",
          "islAmc": "05",
          "odmStmNo": "2025-04-07|8000|521085890011246593"
        },
        "islDty": {
          "islAcklm": "Maaş Ödemesi",
          "krsTrf": {
            "krsMskIBAN": "-",
            "krsMskUnvan": "İsim Soyisim"
          }
        }
      },
      {
  ...
  export const KartlarResponse400={
    ...
    "httpMessage": "Bad Request",
    "moreInformation": "The status of the account is closed.",
    "moreInformationTr": "Sorgulanan kartın durumu kapalıdır.",
    "errorCode": "TR.OHVPS.Business.InvalidAccount",
  }
