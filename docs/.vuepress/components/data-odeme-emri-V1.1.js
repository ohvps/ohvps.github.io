...
export const responseTabsOdemeEmri = [{
  ID: 1,
  Name: '201',
  Color: 'black'
}, {
...
export const odemeEmriRizaHeader = [
  ...
  },
  {
      ID: 5,
      Key: 'X-JWS-Signature',
      Value: 'eyJhbGciOi*****************zovL2FwaS5ia20uY29tLnRyI'
  },
  {
      ID: 6,
      Key: 'PSU-Fraud-Check',
      Value: 'eyJ0eXAiOiJKV1QiLC********************9tYWx5RmxhZyI6IjAiLCJM'
  }, 
  {
      ID: 7,
      Key: 'PSU-Initiated',
  ...
  },    
  {
      ID: 8,
      Key: 'Authorization',
      Value: 'Bearer eyJhbGciOiJ*******************dUIiwia2lkIiA6ICJmdXRo'
  },
];
export const odemeEmriRizaResponseHeader = [
  ...
  },
  {
      ID: 6,
      Key: 'X-JWS-Signature',
      Value: 'eyJhbGciOiJS********************odHRwczovL2FwaS5ia20uY2'
  },
...
export const requestHeadersAfterToken = [
  ...
  },
  {
    ID: 3,
    Key: 'X-Access-Token',
    Value: 'eyJh112334***************2FwaS5ia20uY29tLnRyIiwi'
},
  {
    ID: 4,
    Key:  'X-Request-ID',
  ...
  },
  {
      ID: 7,
      Key: 'X-JWS-Signature',
      Value: 'eyJhbGciO***********************JodHRwczovL2FwaS5ia20uY'
  },
...
export const odemeEmriErisimBelirteciHeader = [
  {
      ID: 9,
      Key: 'X-Access-Token',
      Value: 'eyJh11233******************2FwaS5ia20uY29tLnRyIiwi'
  },
  {
      ID: 3,
      Key: 'X-TPP-Code',
  ...
  },
  {
      ID: 8,
      Key: 'PSU-Fraud-Check',
      Value: 'eyJ0e123456**********************9tYWx5RmxhZyI6IjAiLC'
  },
  {
      ID: 4,
      Key: 'X-JWS-Signature',
      Value: 'eyJhbGciO1234*************************zovL2FwaS5ia20uY29tLnRy'
  },
  {
      ID: 6,
      Key: 'PSU-Initiated',
  ...
  
  {
      ID: 8,
      Key: 'Authorization',
      Value: 'Bearer yJhbGciOiJ*******************dUIiwia2lkIiA6ICJmdXRo'
  },
];
...
export const OdemeEmriRizasi503 = {
...
export const ErisimBelirteciResponse200 =	{
  "erisimBelirteci": "eyJhbGciOiJIU***********************zovL2FwaS5ia20uY29tLnRyIiwiZXhwI",
  "gecerlilikSuresi": 300,
  "yenilemeBelirteci": "eyJhbGciOiJIUz****************czovL2FwaS5ia20uY29tLnR",
...
export const OdemeEmriResponse503 =
{
...
export const OdemeEmriResponse504={
  "id": "abd506a6-0608-4db5-ad5b-723cepde545f",
  "path": "/ohvps/gkd/s1.0/odeme-emri",
  "timestamp": "2023-11-23T15:46:19+03:00",
  "httpCode": 504,
  "httpMessage": "Gateway Timeout",
  "moreInformation": "Gateway Timeout Exception",
