...
| **> Karekod**  | kkod | Kompleks:Karekod   |  	K   |  Karekod ile yapılan düzenli işlemler, talimatın verildiği anda çözülen IBAN'a yapılacaktır.    |Karekod ile düzenli ödeme emri hizmeti desteklenmiyorsa; HHS tarafından hata dönülmelidir.  |
...
| **Ödeme Gerçekleşme Zamanı**	| odmGrckZmn | ISODateTime | K | Ödeme planı içerisindeki ilgili ödemenin gerçekleştiği tarih bilgisidir. Ödeme durumu 01, 02 ve 06 olan kayıtlar için bu alanın gönderilmesi zorunludur.  |
