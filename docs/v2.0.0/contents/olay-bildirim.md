...
|   | HBH | KART_BILGILERI | Kart bilgileri nesnesindeki kart statüsü ile ilgili bir bilgi değiştiğinde oluşturulur.YÖS'e kart statüsünün değiştiğine dair olay bildirimi gönderilir.<br><br>| kartRef |  GET /kartlar,<br> GET /kartlar/{kartRef}/kart-detay,<br> GET /kartlar/{kartRef}/kart-hareketleri | HHS | *Anlık | 1 Dakika 3 kez|
