...
|   | ÖBH | DUZENLI_ODEME_PLANI |Düzenli ödeme planı içerisinde yer alan herhangi bir alan için değişiklik olduğu durumda| talimatNo | /duzenli-odeme-emri/{talimatNo}/odeme-plani| HHS |*Anlık|30 Dakika - 3 Deneme|
