...
| **GEÇİT** | 	BKM API Geçidi	|Bankalararası Kart Merkezi (BKM) tarafından geliştirilen ve taraflara standart Açık Bankacılık işlemleri sunulmasını sağlayan API Geçidi uygulaması | | |
...
| **ÖHS** |Ödeme Hizmeti Sağlayıcısı |5411 sayılı Kanun kapsamındaki bankalar, EPK, ÖDK ve Posta ve Telgraf Teşkilatı Anonim Şirketi(PTT) |Payment Service Provider |PSP |
