...
| **>> Açıklama**	|  odmAcklm   | AN1..200    | K  | ÖBHS’nin ÖHK’dan aldığı ya da kendisinin atadığı işlem açıklaması bilgisi. <br> FAST sistemi üzerinden yapılan ödemeler için en az 1 alfasayısal karakter girilmesi zorunludur.<br>  |  |
...
| **>> Açıklama**	|  odmAcklm   | AN1..200    | K  | ÖBHS’nin ÖHK’dan aldığı ya da kendisinin atadığı işlem açıklaması bilgisi.<br>FAST sistemi üzerinden yapılan ödemeler için en az 1 alfasayısal karakter girilmesi zorunludur.|
...
| **>> Açıklama**	|  odmAcklm   | AN1..200    | K  | ÖBHS’nin ÖHK’dan aldığı ya da kendisinin atadığı işlem açıklaması bilgisi.<br>FAST sistemi üzerinden yapılan ödemeler için en az 1 alfasayısal karakter girilmesi zorunludur.| | **FAST/PÖS Acklm**|
| **>> ÖHK Mesaj Alanı**	|  ohkMsj   | AN1..200    | İ  | HHS’nin ÖHK’ya göstermek üzere ilettiği mesaj.| | |
