...
[^Bölüm 7.8]:  https://ohvps.github.io/v1.0.3/contents/hesap-bilgisi-hizmeti.html#_7-8-adim-3-5-ve-3-6-islemlerin-sorgulanmas%C4%B1/ 

Hesap bilgisi rızasının YÖS tarafından otomatik bir şekilde iptal edilmesi durumu [^Bölüm 9]'da açıklanmıştır.

[^Bölüm 9]:  https://ohvps.github.io/v1.0.3/contents/erisim-belirteci.html